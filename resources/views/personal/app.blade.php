    ...
    <div class="humberger__menu__wrapper">
        ...
        <nav class="humberger__menu__nav mobile-menu">
            <ul>
                ...
                <li><a   class="{{request()->routeIs('shop.grid') ? 'active' : ''}}" href="{{route('shop.grid')}}">Shop</a></li>
                <li><a href="#">Pages</a>
                    <ul class=" ">
                        <li><a class="{{request()->routeIs('shop.details') ? 'active' : ''}}"  href="{{route('shop.details')}}">Shop Details</a></li>
                        <li><a class="{{request()->routeIs('shop.cart') ? 'active' : ''}}"  href="{{route('shop.cart')}}">Shoping Cart</a></li>
                        <li><a class="{{request()->routeIs('checkout') ? 'active' : ''}}" href="{{route('checkout')}}">Check Out</a></li>
                        <li><a class="{{request()->routeIs('blog.details') ? 'active' : ''}}"  href="{{route('blog.details')}}">Blog Details</a></li>
                    </ul>
                </li>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{route('index')}}"><img src="{{ asset('front/img/logo.png') }}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li><a class="{{request()->routeIs('blog.blog') ? 'active' : ''}}"  href="{{route('blog.blog')}}">Blog</a></li>
